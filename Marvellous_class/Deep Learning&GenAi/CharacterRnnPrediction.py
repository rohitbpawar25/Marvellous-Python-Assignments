# ------------------------------------------------------------
# Simple Character-Level RNN for Next-Character Prediction
#
# - Uses a tiny repeating text dataset ("hellohellohellohello")
# - Maps characters to integers and prepares sequences of length 3
# - Trains a SimpleRNN to predict the next character in sequence
# - One-hot encodes output for multi-class classification
# - Tests model prediction on the input ['h', 'e', 'l'] (expects 'l')
# ------------------------------------------------------------
